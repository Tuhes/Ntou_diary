...
class MapthirdviewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let airstation = CLLocationCoordinate2D(latitude: 25.131095, longitude: 121.744542)
